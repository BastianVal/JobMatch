...
class DiscoveryServiceTest {
    ...
    void normalizesSearchAndDefaultsToTwentyFiveResults() {
        ...
        var input = new JobSearchCriteria("  Java backend  ", List.of(), List.of("remote"),
                List.of("full_time"), "mx", "Querétaro", null, null, 30, false, null, null);
        ...
        assertThat(criteria.getValue().state()).isEqualTo("queretaro");
    ...
    private static JobSearchCriteria emptyCriteria() {
        return new JobSearchCriteria(null, List.of(), List.of(), List.of(), null, null, null,
