  ...
  return <section className="explore-page">
    <form className="explore-filters" onSubmit={event=>{event.preventDefault();void search();}}>
      ...
      <details className="filter-details"><summary>Filtros avanzados</summary><div className="filter-grid">
        ...
        <label>Lugar <input value={filters.place} onChange={event=>updateFilter('place',event.target.value)} placeholder="Ej. Puebla, Puebla City o Guadalajara"/><small>Busca por ciudad o estado; no necesitas escribir el nombre exacto.</small></label>
